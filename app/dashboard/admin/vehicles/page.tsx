        ...
        <div className="flex items-center justify-between gap-3 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">{total} total vehicles</p>
            </div>
          </div>
          <Link
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative h-40 bg-gray-100">
                      ...
                      {/* Type badge */}
                      <span className="absolute top-2 left-2 px-2 py-0.5 rounded-full text-xs font-medium bg-black/70 text-white capitalize">
                        {v.vehicleType}
                      </span>
                      {/* Availability badge */}
                      <span
