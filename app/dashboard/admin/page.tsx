...
const ALL_NAV_LINKS = [
  ...
  },
  {
    ...
    permission: P.MANAGE_HOTELS,
    tabLabel: "Hotels",
    icon: <FaHotel className="text-xl" />,
    label: "Hotels",
    desc: "Review hotel listings and verify star ratings",
    color: "bg-indigo-50",
    iconColor: "text-indigo-600",
  },
  {
    href: "/dashboard/admin/event-centers",
    permission: P.MANAGE_EVENT_CENTERS,
    tabLabel: "Events",
    icon: <FaCalendarCheck className="text-xl" />,
    label: "Event Centers",
    desc: "Moderate event venue listings",
    color: "bg-pink-50",
